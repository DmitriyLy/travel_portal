...
<div class="container-fluid fill container-navbar-padding">
    ...
    <div id="actions-container">
        <ul id="subactions-container">
            <li><a href="javascript:void(0)" class="btn btn-fab btn-fab-mini"><i class="material-icons">zoom_in</i></a></li>
            <li><a href="javascript:void(0)" class="btn btn-fab btn-fab-mini"><i class="material-icons">zoom_out</i></a></li>
        </ul>
...
<script type="text/javascript">
    ...
    (function ($) {
        $(document).ready(function(){
            ...
            var marker = MapSingletone.putMarker({
                latitude:40.6700,
                longtitude:-73.9400
            });
        });
