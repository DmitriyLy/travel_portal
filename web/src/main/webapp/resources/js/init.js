define(["require", "exports", "./Controllers/AppController", "./Controllers/DayNightModeEventController", "./Controllers/FloatingButtonsEventController", "./Controllers/MMenuEventController", "./Helpers/ActionBinder", "./Helpers/WindowDrawer"], function (require, exports, AppController_1, DayNightModeEventController_1, FloatingButtonsEventController_1, MMenuEventController_1, ActionBinder_1, WindowDrawer_1) {
    "use strict";
    // Init Map
    ...
    AppController_1.AppController.instances[0].resetMarkers(arr);
    // Modules init
    ...
    if (location.hash.match(/^#marker-([0-9]+)/g)) {
        ...
        if (m.length) {
            WindowDrawer_1.WindowDrawer.drawMarkerWindow(parseInt(m[1]));
        }
    }
    ...
    if (location.hash.match(/^#marker-comments-([0-9]+)/g)) {
        ...
        if (m.length) {
            WindowDrawer_1.WindowDrawer.drawMarkerWindow(parseInt(m[1]), function (MarkerWindow) {
                WindowDrawer_1.WindowDrawer.drawCommentWindow(parseInt(m[1]), MarkerWindow);
            });
        }
    }
});
