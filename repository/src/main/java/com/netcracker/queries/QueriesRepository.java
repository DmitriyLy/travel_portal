...
public interface QueriesRepository {
    ...
    String DELETE_ATTACHMENTS_BY_LABEL =
            "DELETE FROM ATTACHMENTS WHERE label_id=?";
    String DELETE_COMMENTS_BY_LABEL =
            "DELETE FROM COMMENTS WHERE label_id=?";
    String DELETE_CATEGORIES_LABELS_BY_LABEL =
            "DELETE FROM CATEGORIES_LABELS WHERE label_id=?";
    String DELETE_TAGS_LABELS_BY_LABEL =
            "DELETE FROM TAGS_LABELS WHERE label_id=?";
}
